...
public class SubtabledrillEntity {
    ...
    @Basic
    @Column(name = "Ќазвание поставщика", nullable = true, insertable = true, updatable = true, length = 34)
    ...
    @Basic
    @Column(name = "÷ена (из прайса)", nullable = true, insertable = true, updatable = true, length = 7)
    ...
    @Basic
    @Column(name = "Ќаличие (из прайс-листа)", nullable = true, insertable = true, updatable = true, length = 68)
